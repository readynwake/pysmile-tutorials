...
class Tutorial4:
    def __init__(self):
        ...
        gain_definition = [10000, # Utility(Invest=I, Success=S)
    ...
    def create_node(self,
        ...
        #If the value of its outcomes input parameter is null,
        #the outcome initialization is skipped.
        #Utility node do not have outcomes.
